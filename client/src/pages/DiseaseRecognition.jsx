...
export default function DiseaseRecognition() {
  ...
  return (
    <div class="w-full border border-gray-300 shadow-md m-4 bg-white p-8 rounded-md">
      <form class="flex flex-col mt-4" onSubmit={handleSubmit}>
        ...
        />
        <button
          class="self-center mt-4 px-4 py-2 font-bold text-white bg-cyan-950  rounded hover:bg-cyan-700 focus:outline-none focus:shadow-outline"
          type="submit"
          disabled={!file}
        >
          Submit
